                ...
                <Card key={site.id} className="flex flex-col">
                  <CardHeader className="pb-3">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <Badge
                        ...
                        className={
                          site.autoApprove
                            ? "border-success/20 bg-success/10 text-success dark:border-success/20 dark:text-success shrink-0"
                            : "border-warning/20 bg-warning/10 text-warning dark:border-warning/20 dark:text-warning shrink-0"
                        }
                      >
                  ...
                  <CardContent className="flex flex-1 flex-col gap-2 pb-3">
                    ...
                    <div className="flex items-center gap-1.5 font-mono text-xs text-muted-foreground">
                      <Key
                        className="size-3.5 shrink-0 font-sans"
                        aria-hidden="true"
                      />
